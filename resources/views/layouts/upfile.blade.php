...
<head>
    ...
    <link href="{{ URL::asset('uploader/webuploader.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ URL::asset('uploader/theme/uploader.css')}}" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="{{ URL::asset('js/jquery.min.js') }}"></script>
    <script src="{{ URL::asset('uploader/webuploader.min.js')}}"></script>
    {{--<script src="{{ URL::asset('uploader/theme/upload.js')}}"></script>--}}
        ...
        WebUploader.Uploader.register({'before-send-file': 'preupload'}, {
            ...
            preupload: function (file) {
                ...
                owner.md5File(file.source).fail(function () {
                    ...
                    console.log(data);
                    $.ajax("{{route('plug.upstate')}}", {
                        headers: {'X-CSRF-TOKEN': "{{csrf_token()}}"},dataType: 'json', method: 'post', data: data, success: function (ret) {
                            console.log(ret)
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (isSupportBase64) {
                        ...
                        $.ajax('{"plugs/file/preview"|url}', {headers: {'X-CSRF-TOKEN': "{{csrf_token()}}"},method: 'post', data: src, dataType: 'json'}).done(function (response) {
                            if (response.result) {
