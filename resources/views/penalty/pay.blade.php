                            ...
                            @if(session()->has('penalty_info'))
                                ...
                                @foreach ($info_object as $key => $value)
                                    <div class="form-group row">
                                        <label for="{{$key}}"
                                               class="col-md-4 col-form-label text-md-right">{{ $value }}</label>
                                        <div class="col-md-6">
                                            <input name="{{$key}}" class="form-control" type="text"
                                                   value="{{$penalty_info[$key]?$penalty_info[$key]:''}}"
                                                   {{$penalty_info[$key]?'readonly':''}} required>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="modal fade" id="penalty_info" tabindex="-1" role="dialog"
                                     aria-labelledby="penalty_info_label" aria-hidden="true">
