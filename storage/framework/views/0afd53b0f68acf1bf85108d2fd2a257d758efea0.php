...
<html lang="zh-CN">
<head>
    <title>上传行驶证正面图片</title>
    <meta charset="utf-8">
    <link rel="icon" href="../image/favicon.ico">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=0">
    <link href="<?php echo e(URL::asset('uploader/webuploader.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(URL::asset('uploader/theme/uploader.css')); ?>" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('uploader/webuploader.min.js')); ?>"></script>
...
<script>
    ...
    $(function () {
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
            ...
            if (flashVersion) {
                (function (container) {
                    ...
                    var swf = "uploader/theme/expressInstall.swf";
        ...
        WebUploader.Uploader.register({'before-send-file': 'preupload'}, {
            ...
            preupload: function (file) {
                ...
                owner.md5File(file.source).fail(function () {
                    ...
                    file.md5 = md5;
                    var data = {id: file.id, md5: md5, filename: file.name};


                    console.log(data);
                    $.ajax("<?php echo e(route('plug.upstate')); ?>", {
                        headers: {'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"},dataType: 'json', method: 'post', data: data, success: function (ret) {
                            console.log(ret)
        ...
        var uploader = WebUploader.create({
            ...
            accept: {title: '选择文件', extensions: 'png,jpg,gif,jpeg', mimeTypes:'image/'},
            formData: {
        ...
        uploader.on('uploadBeforeSend', function (file, data, header) {
            ...
            header['X-CSRF-TOKEN'] = "<?php echo e(csrf_token()); ?>";
        ...
        uploader.on('uploadAccept', function (fieldata, ret) {
            ...
            if (ret.code === 'SUCCESS') {
                uploaded.call(uploader, ret.url, fieldata.type);
                return true;
            }
            // AliOSS 上传
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (isSupportBase64) {
                        ...
                        $.ajax('{"plugs/file/preview"|url}', {headers: {'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"},method: 'post', data: src, dataType: 'json'}).done(function (response) {
                            if (response.result) {
