...
<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('layui1/css/layui.css')); ?>">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('layui1/lay/modules/layer.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('layui1/layui.all.js')); ?>"></script>
<?php echo $__env->yieldSection(); ?>